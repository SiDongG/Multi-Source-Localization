...
# ax.plot(axis_x,[0,0],color='white')
# ax.plot([0,0],axis_y,color='white')
ax.plot([0,0],[0,0.1])
plt.axis('off')
...
ax.annotate('USB',xy=(11,0),**style)
ax.annotate('Power',xy=(-2,13),**style)
ax.annotate('SD',xy=(-14,0),**style)
ax.annotate('HMDI',xy=(-2,-14),**style)
circ=plt.Circle((0,0), radius = 15, edgecolor = 'b', facecolor='pink')

# ax.annotate('0',xy=(15.5,0),**style)
# ax.annotate('90',xy=(-1,16),**style)
# ax.annotate('180',xy=(-16.99,0),**style)
# ax.annotate('270',xy=(-2,-16.5),**style)

ax.annotate('45',xy=(10.6,10.6),**style)
ax.annotate('135',xy=(-13.6,10.6),**style)
ax.annotate('225',xy=(-13.6,-11.6),**style)
ax.annotate('315',xy=(10.6,-11.6),**style)
ax.add_patch(circ)
...
threshold_label = Label(
        essex,
        text='Change Threshold (120-1000)',
        font=('Times New Roman', 12),
        foreground='white',
        background='blue',
        width='30',
        anchor='center')
threshold_label.grid(row = 2, column = 2)

thresholdInput = Entry(essex,width=30)
thresholdInput.focus_set()
thresholdInput.grid(row = 3, column = 2)
edit_threshold = Button(essex,text="Enter", width = 20, command = change_threshold, pady = 10).grid(row = 4 ,column = 2)


deg_label = Label(
        essex,
        text='Degrees of Forgiveness (0-50)',
        font=('Times New Roman', 12),
        foreground='white',
        background='blue',
        width='30',
        anchor='center')
deg_label.grid(row = 6, column = 2)

degInput = Entry(essex,width=30)
degInput.focus_set()
degInput.grid(row = 7, column = 2)
edit_DoF = Button(essex,text="Enter", width = 20, command = change_degrees, pady = 10).grid(row = 8, column = 2)
...
bright_label = Label(
        ...
        width='30',
        anchor='center')
bright_label.grid(row = 10, column = 2)

brightInput = Entry(essex,width=30)
brightInput.focus_set()
brightInput.grid(row = 11, column = 2)
edit_bright = Button(essex,text="Enter", width = 20, command = change_brightness, pady = 10).grid(row = 12, column = 2)
...
def plot_angle(c_d):
    ...
    for k in range(0,2):
       ...
       ax.plot(vector_x,vector_y,color='green')
    ...
    #style=dict(size=8, color='black')
    #ax.annotate('USB',xy=(11,0),**style)
    #ax.annotate('Power',xy=(-1,11),**style)
    #ax.annotate('SD',xy=(-11,0),**style)
    #ax.annotate('HMDI',xy=(-1,-11),**style)
...
essex.geometry("550x335")
essex.resizable(False, False)
essex.configure(bg = "orange")
