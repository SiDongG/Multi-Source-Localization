...
axs[0, 0].plot(np.arange(len(mic1)), mic4)
axs[0, 0].set_title('Channel4')
axs[0, 1].plot(np.arange(len(mic2)), mic5, 'tab:orange')
axs[0, 1].set_title('Channel5')
axs[1, 0].plot(np.arange(len(mic3)), mic6, 'tab:green')
axs[1, 0].set_title('Channel6')
axs[1, 1].plot(np.arange(len(mic7)), mic8, 'tab:red')
axs[1, 1].set_title('Channel8')
plt.show()
